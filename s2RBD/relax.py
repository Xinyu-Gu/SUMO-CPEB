...
group1 = np.loadtxt('../rbd.dat', dtype='int')
group2 = np.loadtxt('../s2.dat', dtype='int')
...
simulation.reporters.append(PDBReporter(os.path.join(args.to, "relax.pdb"), reporter_frequency))  # output PDBs of simulated structures
...
simulation.step(int(2e7))

#for i in range(1,101):
#    integrator.setTemperature((300-i)*kelvin)
#    simulation.step(int(2e6)/100)
#
simulation.saveState('relax_restart.xml')
