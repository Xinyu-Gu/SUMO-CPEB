...
for force_name in open3SPN2.protein_dna_forces:
    if force_name in ['AMHgoProteinDNA']:
        ...
        force = open3SPN2.protein_dna_forces[force_name](dna, protein, E0=-44*kilocalorie_per_mole, k_string_PDamhgo=1/(kilocalorie_per_mole), chain_protein='A', chain_DNA='B', k_amhgo_PD=0.8*kilocalorie_per_mole, sigma_sq=0.0225*nanometers**2, aaweight=True)
